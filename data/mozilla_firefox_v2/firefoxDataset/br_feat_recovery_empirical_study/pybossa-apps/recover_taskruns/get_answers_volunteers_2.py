# get answers from the last volunteer that contributed through the auxiliary application (project_id=9)
...
BR_2_FEATURE_FILE_PATH_2 = 'mozilla_firefox_v2/firefoxDataset/oracle/output/firefox_v2/feat_br/br_2_feature_matrix_volunteers_2.csv'

if os.path.exists(BR_2_FEATURE_FILE_PATH_2):
    os.remove(BR_2_FEATURE_FILE_PATH_2)

with open(BR_2_FEATURE_FILE_PATH_2, 'w') as br_2_feature_file:
    br_2_feature_file.write(header)


with open(BR_2_FEATURE_FILE_PATH_2, 'a') as br_2_feature_file:
