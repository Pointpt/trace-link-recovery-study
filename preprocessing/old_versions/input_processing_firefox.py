...
BASE_DIR = 'data/mozilla_firefox/firefoxDataset/'
...
class OracleLoader():
    ...
    def __init__(self):
        ...
        self.list_target_artfs = ['TC_{}_TRG'.format(f.replace('.txt','')) for f in os.listdir(BASE_DIR + "/docs_english/TC/") if os.path.isfile(BASE_DIR + "/docs_english/TC/" + f)]
